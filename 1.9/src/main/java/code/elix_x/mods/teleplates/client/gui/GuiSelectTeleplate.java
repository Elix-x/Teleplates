...
public class GuiSelectTeleplate extends GuiScreen {
	...
	public void initGui(){
		...
		password = new GuiTextField(0, fontRendererObj, width / 2 - 128, height - 80, 256, 20);
		buttonList.add(teleport = new GuiButton(0, width / 2 - 128, height - 40, 256, 20, I18n.translateToLocal("teleplates.gui.select.teleport")));
	...
	public class GuiTeleplatesList extends GuiListExtended {
		...
		public class TeleplateEntry implements IGuiListEntry {
			...
			@Override
			public void drawEntry(int slotId, int x, int y, int width, int height, int p_148279_7_, int p_148279_8_, boolean p_148279_9_){
